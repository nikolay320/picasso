 ...
 * @version 1.0.1
 */
add_filter( 'mycred_setup_hooks', 'mycred_register_buddypress_links_hook', 30 );
function mycred_register_buddypress_links_hook( $installed ) {

	if ( ! function_exists( 'bp_links_setup_root_component' ) ) return $installed;
 ...
 * @version 1.1.2
 */
add_action( 'mycred_load_hooks', 'mycred_load_buddypress_links_hook', 30 );
