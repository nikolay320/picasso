 ...
 * @version 1.0.1
 */
add_filter( 'mycred_setup_hooks', 'mycred_register_buddypress_gallery_hook', 25 );
function mycred_register_buddypress_gallery_hook( $installed ) {
 ...
 * @version 1.0.1
 */
add_action( 'mycred_load_hooks', 'mycred_load_buddypress_gallery_hook', 25 );
