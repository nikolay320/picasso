...
if ( ! function_exists( 'mycred_load' ) ) :
	function mycred_load() {
		...
		add_action( 'after_setup_theme', 'mycred_after_setup_theme', 50 );
...
/**
 * After Theme Setup
 * Tasks that needs to run before init but after plugins
 * being loaded and setup.
 * @since 1.6.8
 * @version 1.0
 */
if ( ! function_exists( 'mycred_after_setup_theme' ) ) :
	function mycred_after_setup_theme() {
