...
<?php   if ($field_output = $this->Entity_RenderField($entity, $field, $view)):?>
    <div class="sabai-questions-field sabai-field-type-<?php echo str_replace('_', '-', $field->getFieldType());?> sabai-field-name-<?php echo str_replace('_', '-', $field->getFieldName());?> sabai-clearfix">
