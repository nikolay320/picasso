        ...
        <div class="">
            ...
            <div class="cpm-file-action">
                <ul>
                    ...
                    <?php if ( get_current_user_id() == $attachment->post_author ) { ?>
                        <li class="cpm-pro-delete-file"> <span class="cpm-loading cpm-right cpm-hide"></span>  <a href="JavaScript:void(0)" class="dashicons-before dashicons-trash" data-id="<?php echo $file['id'] ?>" data-pid="<?php echo $project_id ?>"> </a> </li>
                        <?php } ?>
                </ul>
            </div>
        </div>
