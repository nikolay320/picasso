...
class CPM_Ajax {
    ...
    function new_message() {
        ...
        if ( cpm_user_can_access( $project_id, 'create_message' ) ) {
			...
			if(is_admin() && isset($posted['milestone']) ):	//added code for frontend by Mansur
			...
			else: //added code for frontend by Mansur
			$url = "#"; //added code for frontend by Mansur
			endif;//added code for frontend by Mansur
