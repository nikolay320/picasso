<div class="cpm-blank-template file-list">
    <div class="cpm-content" >
        ...
        <p>
            <?php _e( 'Access all the files from all threads in one place. Store your project related files, docs, images or any other files on-site. Makes sharing and storing easy and convenient, plus you can add privacy here too.', 'cpm' ) ?>
        </p>
