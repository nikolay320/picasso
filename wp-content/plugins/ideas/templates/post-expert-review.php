        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="pull-right">
                    ...
                    <input type="submit" class="btn btn-primary idea-review-button" value="<?php _e('Submit', IDEAS_TEXT_DOMAIN); ?>" data-review-id="<?php echo $review_id; ?>" data-ajax-url="<?php echo admin_url('admin-ajax.php'); ?>" data-action="klc_post_review_for_idea" data-notify-message="<?php _e('Your review was posted successfully', IDEAS_TEXT_DOMAIN); ?>" />
                </div>
            </div>
        </div>
    <?php endif ?>
