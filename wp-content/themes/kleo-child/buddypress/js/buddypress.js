...
sabai_mediapress_show_video ();
	...
	jq('div.activity').on('click', '.activity-read-more a', function(event) {
		...
		var event_inner = jq(a_inner).find('.eventon_events_list.desc_trig');
		if(event_inner){
			jq('body').append(event_inner.prop('outerHTML'));
		}
...
setTimeout(sabai_mediapress_show_video, 3000);
...
function sabai_mediapress_show_video () {
	...
	jQuery('.sabai-idea-youtube-video').each(function() {
		...
		var youtubeiframe = '<iframe width= src="https://www.youtube.com/embed/'+youtubeid+'" frameborder="0" allowfullscreen></iframe>';
