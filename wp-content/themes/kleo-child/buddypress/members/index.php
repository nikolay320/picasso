...
<style>
div.kleo-child-bp-member-container {
	position: relative;
}
	...
	<form action="" method="post" id="members-directory-form" class="dir-form">
		...
		<div id="subnav" class="item-list-tabs" role="navigation">
			<ul>
				...
				<?php if (function_exists('kleo_bp_member_types_tabs_select')) : ?>
					<li id="kleo_bp_member_select" class="kleo_bp_member_select">
						<div class="kleo-child-bp-member-container"><?php echo kleo_bp_member_types_tabs_select(); ?></div>
					</li>
				<?php endif; ?>
