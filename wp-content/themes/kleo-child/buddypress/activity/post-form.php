...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	?></p>		
		<script>			
			jQuery(function($){
				$('#go').click(function(){
					var my_var = $(this).attr('data-my_html'); 
					var txt_val=$('#whats-new').val();
					//$('#whats-new').text( txt_val+ ' '+ my_var + 'a');
					var newVal=$.trim(txt_val+' '+ my_var + 'a');
					$('#whats-new').attr('value', newVal);
					$('.bp-suggestions').trigger("keyup");
					setTimeout(function()
					{
						var newVal=$.trim(txt_val+' '+ my_var);
						$('#whats-new').attr('value', newVal);
					},200);										
				}); 
	...
	<div id="whats-new-content">
		<div id="whats-new-textarea">
			<textarea class="bp-suggestions" name="whats-new" id="whats-new" cols="50" rows="10"><?php if ( isset( $_GET['r'] ) ) : ?>@<?php echo $_GET['r']; ?><?php endif; ?></textarea>			
		</div>

		<div id="whats-new-options">
			<div id="whats-new-submit">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php esc_attr_e( 'Post Update', 'buddypress' ); ?>" />
				<input type="button" id="go" data-my_html="&#64;" value="&#64;" name="&#64;" class="keypress" data-code="65" />
			</div>
