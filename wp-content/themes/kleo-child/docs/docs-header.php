...
<?php if ( bp_docs_is_existing_doc() ) : ?>
	...
	<div id="bp-docs-single-doc-header">
		<?php if ( ! bp_docs_is_theme_compat_active() ) : ?>
			<h2 class="doc-title"><?php echo kleo_child_bp_docs_icon();?><span class="breadcrumb-current"><?php echo the_title();?></span><?php //bp_docs_the_breadcrumb() ?><?php if ( bp_docs_is_doc_trashed() ) : ?> <span class="bp-docs-trashed-doc-notice" title="<?php esc_html_e( 'This Doc is in the Trash', 'bp-docs' ) ?>">Trash</span><?php endif ?></h2>
		<?php endif ?>
